      ...
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/register?role=merchant" className="text-muted-foreground hover:text-foreground">
                  {t("footer.registerBusiness")}
                </Link>
              </li>
              <li>
                <Link href="/merchant" className="text-muted-foreground hover:text-foreground">
                  {t("header.merchantDashboard")}
                </Link>
              </li>
              <li>
