  ...
  const receivedRequests: Request[] = [
    {
      ...
      message: "Bonjour, je souhaiterais réserver une table pour 12 personnes samedi prochain. Est-ce possible ?",
      status: "pending",
      date: "2025-01-28",
    },
    {
      ...
      customerEmail: "fatou.diallo@example.com",
      subject: "Menu végétarien",
      message:
        "Avez-vous des options végétariennes dans votre menu ? Je suis intéressée par votre cuisine mais je ne mange pas de viande.",
      status: "answered",
      date: "2025-01-27",
      response: "Oui, nous avons plusieurs plats végétariens délicieux. Consultez notre menu en ligne ou appelez-nous.",
    ...
    },
    {
      ...
      message: "Je voudrais organiser un événement privé pour 30 personnes. Proposez-vous ce service ?",
      status: "closed",
      date: "2025-01-26",
      response: "Oui, nous organisons des événements privés. Contactez-nous pour discuter des détails.",
